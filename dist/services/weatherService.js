...
export const getWeatherData = async (lat, lon, cityName, country) => {
...
export const getHourlyWeatherData = async (lat, lon, cityName, country) => {
    try {
        const response = await axios.get(`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&hourly=temperature_2m,relative_humidity_2m,precipitation_probability,weather_code,wind_speed_10m&timezone=auto&forecast_days=1`);
